...
**🧪 Démo en ligne** : https://lgdlcs.github.io/feux-france/ — instantané **figé et daté** (GitHub Pages ne peut pas héberger le backend), avec bandeau explicite ; pour le temps réel, lancez le serveur localement (ci-dessous). Régénérer la démo : `python3 scripts/make_demo.py` puis commit de `docs/`.
